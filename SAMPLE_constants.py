...
KNOWN_CRASHES_BACKUP = {
    ...
    "ar_wal_tx_sch_status.c:645": "AOS-246184 (bug fix will be in 8.10.0.10)",
    ...
    "ar_wal_monitor.c:911": "AOS-243440",
    "ratectrl_txbf.c:184": "AOS-248767",
    "PC:0x00000000": "AOS-245788",
}
